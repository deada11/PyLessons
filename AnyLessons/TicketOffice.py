...
original_discount_age_revenue = 0
new_discount_age_revenue = 0

for years in data.values():
    if years < 18:
        original_discount_age_revenue += price_with_discount
    else:
        original_discount_age_revenue += price_without_discount

for years in data.values():
    if years < age:
        new_discount_age_revenue += price_with_discount
    else:
        new_discount_age_revenue += price_without_discount

print(
    int(
        ((new_discount_age_revenue-original_discount_age_revenue)/original_discount_age_revenue)*100
    )
)
